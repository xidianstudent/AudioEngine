...
//  NS_Testbed
//
//  Created by PandaABC on 2018/12/7.
//  Copyright © 2018 lbzhao. All rights reserved.
//
...
int main(int argc, const char * argv[]) {
    @autoreleasepool {
        ...
        //读取pcm数据，带噪声
        FILE *iFile = fopen("/Users/pandaabc/Desktop/resource/ns/output_float.pcm", "rb");
        if (!iFile) {
            return 0;
        }
        
        FILE *oFile = fopen("/Users/pandaabc/Desktop/resource/ns/dst1.pcm", "wb");
        if (!oFile) {
            return 0;
        }
...
//            memcpy(outframe, spframe, sizeof(float) * num_bands);
            ...
            NSLog(@"nsdata1 = %f,data2 = %f",*outFrame[0],*outFrame[1]);
        }
